        ...
        if ($driver instanceof StreamSelectDriver) {
            if (EvDriver::isSupported()) {
                return Advice::forPerformance(
                    ...
                    'The "'
                    . EvDriver::class
                    . '" driver is supported. For better performance, use it instead of the "'
                    . StreamSelectDriver::class
                    . '" driver.',
                    'Remove the "REVOLT_DRIVER" environment variable to allow the system to automatically switch to "'
                    . EvDriver::class
                    . '".',
                );
            }
            ...
            return Advice::forPerformance(
                ...
                'For better performance, install ext-uv, ext-event, or ext-ev. The "'
                . StreamSelectDriver::class
                . '" is a fallback and not optimal for production environments.',
